package com.alina1234.app.classwork.lesson5;
...
public class BasicTests {
    ...
    private static final String RESOURSES_PATH = "src/test/java/resourses/";
    private static final String INPUT_DATA = RESOURSES_PATH + "input";
    private static final String EXPECTED_RESULTS = RESOURSES_PATH + "expected";
